...
8. Run JSON을 Execution Trace, Variables, Report view로 변환해 표시한다. Phase 24 기준 Execution Trace와 Variables는 run 종료 후 snapshot table로 표시한다.
...
- Execution Trace event detail panel
